...
export const digestParagraphs: string[] = [
  'Q2 2026. Building EDGE Diagnostic v2, a 25-minute structured conversation that produces a board-ready AI capability snapshot. Advising two businesses, both anonymous on the public site: a catering business in Singapore where I am also an investor, and a professional services firm in Malaysia. Drafting the EDGE field manual for nominating committees, due Q3.',
  'SDG Open Hack 2026 NP Edition mentorship runs from late May. Moderating Ortus Club executive roundtables on a rolling basis. Standing panellist work continues across business strategy, operational implementation, and AI. Reading: Heffernan, Levinson, Slouka, Tett, McGilchrist.',
