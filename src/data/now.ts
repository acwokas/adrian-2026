...
// The reading mention in paragraph two is templated from src/data/reading.ts
...
export const digestParagraphs: string[] = [
  ...
  `SDG Open Hack 2026 NP Edition mentorship is underway. Moderating Ortus Club executive roundtables on a rolling basis. Standing panellist work continues across business strategy, operational implementation, and AI. ${digestReadingLine()}`,
