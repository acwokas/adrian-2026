...
What a Chief AI Officer does well, for a window, is force the conversation and set the standards, pushing the governance scaffolding into place. That's real work. But it's scaffolding work, not a permanent function.

Once the operating model has absorbed AI into how decisions actually get made, the seat dissolves into the seats that were always going to own it.

If the role is still there in two years, the transformation didn't happen. Someone just got a title.
